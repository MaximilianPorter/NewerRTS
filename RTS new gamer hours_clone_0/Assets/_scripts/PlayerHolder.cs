...
public class PlayerHolder : MonoBehaviour
{
    ...
    public static Camera[] GetPlayerCameras => playerCams;
   ...
   // private Identifier[] debugIdentifiers;

    //public static void SetPlayerDetails (Identifier identifier, Camera cam, RectTransform canvas)
    //{
    //    playerIdentifiers[identifier.GetPlayerID] = identifier;
    //    playerCams[identifier.GetPlayerID] = cam;
    //    playerCanvasRects[identifier.GetPlayerID] = canvas;
    //}
    ...
    private void Start()
    {
        GameObject[] playerGameObjects = GameObject.FindGameObjectsWithTag("Player").OrderBy(player => player.GetComponent<Identifier>().GetPlayerID).ToArray();
